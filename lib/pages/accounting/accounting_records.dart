...
import 'package:flutter_app/pages/accounting/components/accounting_records/accounting_records_body.dart';

class AccountingRecordsEditorPage extends StatefulWidget {
  const AccountingRecordsEditorPage({Key? key}) : super(key: key);

  @override
  State<AccountingRecordsEditorPage> createState() => _AccountingRecordsEditorPageState();
}

class _AccountingRecordsEditorPageState extends State<AccountingRecordsEditorPage> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => AccountingRecordsEditorPage()))
          },
