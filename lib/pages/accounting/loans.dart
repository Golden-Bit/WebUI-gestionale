...
import 'package:flutter_app/pages/accounting/components/loans/loans_body.dart';

class LoansEditorPage extends StatefulWidget {
  const LoansEditorPage({Key? key}) : super(key: key);

  @override
  State<LoansEditorPage> createState() => _LoansEditorPageState();
}

class _LoansEditorPageState extends State<LoansEditorPage> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => LoansEditorPage()))
          },
