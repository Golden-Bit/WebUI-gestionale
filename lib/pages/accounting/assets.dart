...
import 'package:flutter_app/pages/accounting/components/assets/assets_body.dart';

class AssetsEditorPage extends StatefulWidget {
  const AssetsEditorPage({Key? key}) : super(key: key);

  @override
  State<AssetsEditorPage> createState() => _AssetsEditorPageState();
}

class _AssetsEditorPageState extends State<AssetsEditorPage> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => AssetsEditorPage()))
          },
