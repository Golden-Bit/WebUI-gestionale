...
import 'package:flutter_app/pages/accounting/components/products/products_body.dart';

class ProductsEditorPage extends StatefulWidget {
  const ProductsEditorPage({Key? key}) : super(key: key);

  @override
  State<ProductsEditorPage> createState() => _ProductsEditorPageState();
}

class _ProductsEditorPageState extends State<ProductsEditorPage> {
