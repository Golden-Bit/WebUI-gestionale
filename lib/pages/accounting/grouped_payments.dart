...
import 'package:flutter_app/pages/accounting/components/grouped_payments/grouped_payments_body.dart';

class GroupedPaymentsEditorPage extends StatefulWidget {
  const GroupedPaymentsEditorPage({Key? key}) : super(key: key);

  @override
  State<GroupedPaymentsEditorPage> createState() => _GroupedPaymentsEditorPageState();
}

class _GroupedPaymentsEditorPageState extends State<GroupedPaymentsEditorPage> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => GroupedPaymentsEditorPage()))
          },
