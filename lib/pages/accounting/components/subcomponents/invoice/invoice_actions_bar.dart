...
class _InvoiceActionsBarState extends State<InvoiceActionsBar> {
  ...
  Widget _buildConfirmedButtons() {
    return Row(
      children: [
        _buildCustomButton("Invia", backgroundColor: const Color(0xFF6B3A5B), textColor: Colors.white, onTap: _handleResetToDraft),
        const SizedBox(width: 8),
        _buildCustomButton("Registra pagamento", backgroundColor: const Color(0xFF6B3A5B), textColor: Colors.white, onTap: _handleResetToDraft),
        const SizedBox(width: 8),
        _buildCustomButton("Anteprima", backgroundColor: Colors.grey[200], onTap: _handleResetToDraft),
        const SizedBox(width: 8),
        _buildCustomButton("Nota di credito", backgroundColor: Colors.grey[200], onTap: _handleResetToDraft),
        const SizedBox(width: 8),
