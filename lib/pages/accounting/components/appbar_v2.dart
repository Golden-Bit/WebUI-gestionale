...
final ValueChanged<int> onPageChanged;
  ...
  final VoidCallback onCaricaPressed;
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
  // Calcolo dinamico dell’intervallo
...
TextButton(
  onPressed: currentPage > 0 
    ...
    : null, // se sei già a pagina 0, disabilitiamo
  style: TextButton.styleFrom(
...
// Freccia destra
TextButton(
  onPressed: ((currentPage + 1) * pageSize) < totalItems
    ? () {
        onPageChanged(currentPage + 1);
      }
    : null, // se non ci sono più pagine disponibili, disabilitiamo
  style: TextButton.styleFrom(
    backgroundColor: const Color(0xFFEAEAEA),
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(4),
