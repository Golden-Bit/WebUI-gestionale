...
class GroupedPaymentsViewPage extends StatefulWidget {
  const GroupedPaymentsViewPage({Key? key}) : super(key: key);

  @override
  State<GroupedPaymentsViewPage> createState() => _GroupedPaymentsViewPageState();
}

class _GroupedPaymentsViewPageState extends State<GroupedPaymentsViewPage> {
                  ...
                  switch (selectedViewIndex) {
                    case 0: // Elenco
                      return buildListPlaceholder(
                        collectionName: "grouped_payments",
