...
import 'package:flutter_app/pages/accounting/components/transfers/transfers_body.dart';

class TransfersEditorPage extends StatefulWidget {
  const TransfersEditorPage({Key? key}) : super(key: key);

  @override
  State<TransfersEditorPage> createState() => _TransfersEditorPageState();
}

class _TransfersEditorPageState extends State<TransfersEditorPage> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => TransfersEditorPage()))
          },
