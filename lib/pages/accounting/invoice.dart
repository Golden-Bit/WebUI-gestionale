...
import 'package:flutter_app/pages/accounting/components/invoice/invoice_body.dart';

class InvoiceEditorPage extends StatefulWidget {
  const InvoiceEditorPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => InvoiceEditorPage()))
          },
