...
class LoansViewPage extends StatefulWidget {
  const LoansViewPage({Key? key}) : super(key: key);

  @override
  State<LoansViewPage> createState() => _LoansViewPageState();
}

class _LoansViewPageState extends State<LoansViewPage> {
