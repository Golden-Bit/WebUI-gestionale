...
class AnalyticMovementsViewPage extends StatefulWidget {
  const AnalyticMovementsViewPage({Key? key}) : super(key: key);

  @override
  State<AnalyticMovementsViewPage> createState() => _AnalyticMovementsViewPageState();
}

class _AnalyticMovementsViewPageState extends State<AnalyticMovementsViewPage> {
                  ...
                  switch (selectedViewIndex) {
                    case 0: // Elenco
                      return buildListPlaceholder(
                        collectionName: "analytic_movements",
