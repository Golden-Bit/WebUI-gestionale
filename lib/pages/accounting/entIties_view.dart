...
class EntitiesViewPage extends StatefulWidget {
  const EntitiesViewPage({Key? key}) : super(key: key);

  @override
  State<EntitiesViewPage> createState() => _EntitiesViewPageState();
}

class _EntitiesViewPageState extends State<EntitiesViewPage> {
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          selectedViewIndex: selectedViewIndex,
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => EntitiesEditorPage()))
          },
          onCaricaPressed: () => {},
          onViewChanged: (index) {
            setState(() {
