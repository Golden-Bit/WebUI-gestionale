...
import 'package:flutter_app/pages/accounting/components/payment/payment_body.dart';

class PaymentEditorPage extends StatefulWidget {
  const PaymentEditorPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
          ...
          label2: 'Sottotitolo',
                    onNuovoPressed: () => {
            Navigator.push(context, MaterialPageRoute(builder: (context) => PaymentEditorPage()))
          },
