...
class AccountingRecordsViewPage extends StatefulWidget {
  const AccountingRecordsViewPage({Key? key}) : super(key: key);

  @override
  State<AccountingRecordsViewPage> createState() => _AccountingRecordsViewPageState();
}

class _AccountingRecordsViewPageState extends State<AccountingRecordsViewPage> {
                  ...
                  switch (selectedViewIndex) {
                    case 0: // Elenco
                      return buildListPlaceholder(
                        collectionName: "accounting_records",
